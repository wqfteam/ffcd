...
CREATE TABLE `sys_menu` (
  `menu_id` varchar(64) NOT NULL AUTO_INCREMENT,
  `parent_id` varchar(64) COMMENT '父菜单ID，一级菜单为0',
...
CREATE TABLE `sys_user` (
  ...
  `create_user_id` varchar(64) COMMENT '创建者ID',
...
CREATE TABLE `sys_role` (
  `role_id` varchar(64) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sys_log` (
  ...
  `time` varchar NOT NULL COMMENT '执行时长(毫秒)',
...
CREATE TABLE `schedule_job` (
  `job_id` varchar(64) NOT NULL AUTO_INCREMENT COMMENT '任务id',
...
CREATE TABLE `schedule_job_log` (
  `log_id` varchar(64) NOT NULL AUTO_INCREMENT COMMENT '任务日志id',
...
-- 初始数据 
INSERT INTO `sys_user` (`user_id`, `username`, `password`, `salt`, `email`, `mobile`, `status`, `create_user_id`, `create_time`) VALUES ('1', 'admin', '9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d', 'YzcmCZNvbXocrsz9dm8e', 'root@wqfang.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (5, 1, 'SQL监控', 'http://localhost:8080/wqfang-fast/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO `schedule_job` (`bean_name`, `params`, `cron_expression`, `status`, `remark`, `create_time`) VALUES ('testTask', 'wqfang', '0 0/30 * * * ?', '0', '参数测试', now());
...
JOB_GROUP VARCHAR(200) NOT NULL,
DESCRIPTION VARCHAR(250) NULL,
NEXT_FIRE_TIME varchar(13) NULL,
PREV_FIRE_TIME varchar(13) NULL,
PRIORITY INTEGER NULL,
TRIGGER_STATE VARCHAR(16) NOT NULL,
TRIGGER_TYPE VARCHAR(8) NOT NULL,
START_TIME varchar(13) NOT NULL,
END_TIME varchar(13) NULL,
...
TRIGGER_NAME VARCHAR(200) NOT NULL,
TRIGGER_GROUP VARCHAR(200) NOT NULL,
REPEAT_COUNT varchar(7) NOT NULL,
REPEAT_INTERVAL varchar(12) NOT NULL,
TIMES_TRIGGERED varchar(10) NOT NULL,
PRIMARY KEY (SCHED_NAME,TRIGGER_NAME,TRIGGER_GROUP),
...
CREATE TABLE QRTZ_SIMPROP_TRIGGERS
  (          
    ...
    INT_PROP_1 INT NULL,
    INT_PROP_2 INT NULL,
    LONG_PROP_1 varchar NULL,
    LONG_PROP_2 varchar NULL,
...
FIRED_TIME varchar(13) NOT NULL,
SCHED_TIME varchar(13) NOT NULL,
...
SCHED_NAME VARCHAR(120) NOT NULL,
INSTANCE_NAME VARCHAR(200) NOT NULL,
LAST_CHECKIN_TIME varchar(13) NOT NULL,
CHECKIN_INTERVAL varchar(13) NOT NULL,
