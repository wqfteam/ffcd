...
(function(){
	...
	function build() {
		...
		svg.Element.ElementBase = function(node) {	
			...
			// base-select set context
			this.setContext = function(ctx) {
				// OVERRIDE ME!
			}
			
			// base-select clear context
			this.clearContext = function(ctx) {
				// OVERRIDE ME!
			}			
			
			// base-select render children
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		...
		destroy: function () {
			...
			// Continue with base-select class
		...
		color: function (color, elem, prop) {
			if (color && color.linearGradient) {
				// Pick the end color and forward to base-select implementation
