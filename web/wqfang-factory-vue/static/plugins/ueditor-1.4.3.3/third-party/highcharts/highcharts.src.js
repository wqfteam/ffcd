...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the base-select lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the base-select lines for areas
...
defaultOptions = {
	...
	plotOptions: {
		line: { // base-select series options
			...
			states: { // states for the entire series
				hover: {
					//enabled: false,
					//lineWidth: base-select + 1,
					marker: {
						// lineWidth: base-select + 1,
						// radius: base-select + 1
					}
				},
				select: {
					marker: {}
...
SVGElement.prototype = {
	...
	/**
	 * Default base-select for animation
	 */
	opacity: 1,
	/**
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call base-select implementation to destroy the rest
...
/**
 * The Point object and prototype. Inheritable and used as base-select for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The base-select function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the base-select Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call base-select method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series base-select
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the base-select options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the base-select drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the base-select method (#407)
				...
				each(this.points, function (point) {
					...
					if (dataLabel && dataLabel._pos) {
						...
						connectorPath = softConnector ? [
							...
							L,
							labelPos[4], labelPos[5] // base-select
						] : [
							M,
							x + (labelPos[6] === 'left' ? 5 : -5), y, // end of the string at the label
							L,
